...
class Flight:
    def __init__(self, flight_number, flight_name, capacity):
        ...
        # Define seats by class and type (window, middle, aisle)
        self.seats = {
            'premium': {
...
class Booking:
    def __init__(self, booking_id, flight_number, seat_type, seat_position):
        ...
        self.seat_position = seat_position  # New: window/middle/aisle
...
def book_ticket(booking_id, flight_number, seat_type, seat_position):
    ...
    for flight in flights:
        if flight.flight_number == flight_number:
            # Check seat availability for the given seat type and position
